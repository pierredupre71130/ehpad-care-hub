...
import { PhoneCall, ShieldCheck, UserCog, ScrollText, Scale, Megaphone, FileDown } from 'lucide-react';
      ...
      <DialogContent className="max-w-sm">
        ...
        <div className="border-t border-slate-100 pt-3 mt-1">
          ...
          >
            ...
            <div>
              <div>Import Personnes à Prévenir</div>
              <div className="text-xs text-slate-400 font-normal">Import depuis PDF — 30/04/2026</div>
            </div>
          </Link>
        </div>
        )}
